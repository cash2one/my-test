...
static uint32_t session_hashfn(uint8_t ucPro,uint32_t ulSrcIp,uint32_t ulDstIp,uint16_t usSrcPort,uint16_t usDstPort)
{
	//uint32_t index;
	//uint32_t a,b;
	...
	/*
	index = TluHash(ulSrcIp,ulDstIp);
	a = ((((uint32_t)usSrcPort) << 16) & 0xffff0000) + usDstPort;
	b = (((uint32_t)ucPro) << 24) & 0xff000000;
	index += TluHash(a,b);
