...
#include "gms_tables.h"
#include "make_log.h"

/* log 模块日志 */
#define PSQL_LOG_MODULE                     "database"
#define PSQL_LOG_PROC                       "postgresql"
...
#define GPQ_CONN_INFO_SIZE            sizeof(struct gpq_conn_info)
