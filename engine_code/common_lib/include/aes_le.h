...
typedef struct
{
	...
	const u_int64_t t0[256];
	const u_int64_t t1[256];
	const u_int64_t t2[256];
	const u_int64_t t3[256];
	#else
	const u_int32_t t0[256];
	const u_int32_t t1[256];
	const u_int32_t t2[256];
	const u_int32_t t3[256];
	#endif
	const u_int32_t t4[256];
} _table;
